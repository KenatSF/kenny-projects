    ...
    return (
        <Box>
            <Grid templateColumns="repeat(1, minmax(250px, 1fr))" gap={6}>
                ...
                <Projectinfo image={"/datascience/asset.png"} linkTo={"https://github.com/KenatSF/Bitcoin-fall-prediction/blob/main/project_r/2_model_selection.ipynb"} samePage={false} imageTittle={data.projectsAssetTittle} imageDescription={data.projectsAssetDescription} imageView={data.projectsAssetView} imageButton={data.projectsButton} />
