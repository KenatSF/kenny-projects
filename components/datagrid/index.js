    ...
    return (
        <Box>
            <Grid templateColumns="repeat(1, minmax(250px, 1fr))" gap={6}>
                ...
                <Projectinfo image={"/datascience/stockindices.jpg"} linkTo={"https://github.com/KenatSF/Heavy-Indexes"} samePage={false} imageTittle={data.projectsStockTittle} imageDescription={data.projectsStockDescription} imageView={data.projectsStockView} imageButton={data.projectsButton}/>
                <Projectinfo image={"/datascience/market.jpg"} linkTo={"https://github.com/KenatSF/Basic_Data_Analysis"} samePage={false} imageTittle={data.projectsMarketSalesTittle} imageDescription={data.projectsMarketSalesDescription} imageView={data.projectsMarketSalesView} imageButton={data.projectsButton}/>
                <Projectinfo image={"/datascience/asset.jpg"} linkTo={"https://github.com/KenatSF/Bitcoin-fall-prediction"} samePage={false} imageTittle={data.projectsAssetTittle} imageDescription={data.projectsAssetDescription} imageView={data.projectsAssetView} imageButton={data.projectsButton}/>
